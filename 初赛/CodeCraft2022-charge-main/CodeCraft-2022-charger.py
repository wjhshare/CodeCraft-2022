                    ...
                    for site_id in range(len(Site)):
                        if(Site[site_id].sitename==one_tmp[0]):#找节点的名字
                            ...
                            if Site[site_id].used[day]>Site[site_id].bandwidth:
                                ...
                                print("使用了: ",Site[site_id].used)
                                print("带宽上限: ",Site[site_id].bandwidth)
                                print("在客户节点: ",Client[find_index].name, " 出现的")
                                exit()
                            break
                    if(flag==0):
...
if __name__ == '__main__':
    #读取输入文件
    dfile = '/data'
    demandFile = '/home/qunlou/huawei/SDK/SDK_C++' + dfile + '/demand.csv'
    site_bandwidthFile = '/home/qunlou/huawei/SDK/SDK_C++' + dfile + '/site_bandwidth.csv'
    solutionFile = '/home/qunlou/huawei/SDK/SDK_C++/output/solution.txt'
    qosFile='/home/qunlou/huawei/SDK/SDK_C++' + dfile + '/qos.csv'
